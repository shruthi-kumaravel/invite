        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="" method="post" class="multisend_form">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card shadow py-4 invite_card">
                                    <div class="card-header py-3 invite_cardHead">
                                        <h3 class="m-0 font-weight-bold text-primary">Create the Invite</h3>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <h5>Title</h5>
                                            <label for="inviteTitle"></label>
                                            <input type="text" name="inviteTitle" id="inviteTitle" class="form-control"
                                                autocomplete="off" required>
                                        </div>
                                        <div class="form-group">
                                            <h5>Please input your invitation</h5>
                                            <label for="inviteContent"></label>
                                            <textarea name="inviteContent" id="inviteContent" class="form-control"
                                                cols="30" rows="15" autocomplete="off" required></textarea>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" name="send_invite" value="send_invite">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>                                                               
                                                                                <div class='form-check'>                                                                   
                                                                                    <input type='checkbox' class='form-check-input' id='selectedUsers' name='selectedUsers[]' value='".$row['id']."'>                                                                 
                                                                                </div>
                                                                            </td>                                                       
                                                                        </tr>
                                                                    ";
                                        ...
                                        <div class="form-group mt-3">
                                            <input type="button" class="btn btn-primary send_invite"
                                                value="Send Invite">
                                        </div>
